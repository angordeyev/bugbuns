...
```shell
wget https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.8.5.tar.xz
```
...
Download Firecracker from [the release page](https://github.com/firecracker-microvm/firecracker/releases) or install `firecracker` package.
